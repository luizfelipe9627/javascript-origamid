...
let button = document.querySelector(".btn"); // Usamos o document(objeto) e o querySelector(método/função) para selecionar um elemento HTML pelo JS utilizando a Classe ou ID atribuído ao elemento.
console.log(button); // Retorna <button class="btn">Clique aqui</button> no console.
